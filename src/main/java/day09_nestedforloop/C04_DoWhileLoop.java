...
if(muzSayisi<4){
    maymunAlive=false;
    System.out.println("bugun" +(hayattaKalmaDays+1) + ". gun, yasamasina yetecek kadar muz kalmadi.Maymun oldu");
}else{
    System.out.println("bugun" + hayattaKalmaDays+ "gun yasadi muz bitmedi.Maymun hayatta");
}


        } while (maymunAlive);
        System.out.println("Toplam maymunun yasadigi gun sayisi:"+ hayattaKalmaDays);
    }
}